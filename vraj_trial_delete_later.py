...
# r1_venus = (r1_venus_eph.xyz - r_sun1.xyz).to(u.m).value  # type:ignore
# v1_venus = (v1_venus_eph.xyz - v_sun1.xyz).to(u.m/u.s).value  # type:ignore
...
r1_earth = np.array([1.00000261*AU,0,0])
r2_venus = np.array([0.72333566*AU,0,0])
delta_f = np.deg2rad(60)
r2_venus = np.array([ [np.cos(delta_f) ,-np.sin(delta_f) ,0 ] , [np.sin(delta_f) , np.cos(delta_f),0], [ 0 , 0, 1] ]) @ r2_venus.reshape(3,1)
r2_venus = r2_venus.flatten()
tof = TimeDelta(60,format='jd')

# (v1_short, v2_short),= izzo.lambert(k, r1_earth*u.m, r2_mars*u.m , (tof.sec*u.s))
print("VALLADO FUNCTION")
(v1_short, v2_short),= vallado.lambert(k, r1_earth*u.m, r2_venus*u.m , (tof.sec*u.s),short=True,numiter=1000)
print("Short Orbit Transfer")
print(f"Departure velocity: {v1_short}")
print(f"Arrival velocity: {v2_short}\n")

(v1_short, v2_short),= vallado.lambert(k, r1_earth*u.m, r2_venus*u.m , (tof.sec*u.s),short=False,numiter = 1000)
...
print("JONS FUNCTION")
print("Short Orbit Transfer")
transfer_short.a, transfer_short.p, transfer_short.e, transfer_short_v1, transfer_short_v2 = lambert_solver(r1_earth, r2_venus, (tof.sec), transfer_short.mu, desired_path='short')
...
print("Long Orbit Transfer")
transfer_long.a, transfer_long.p, transfer_long.e, transfer_long_v1, transfer_long_v2 = lambert_solver(r1_earth, r2_venus, (tof.sec), transfer_short.mu, desired_path='long')
...
print("VRAJ FUNCTION")
print("Short Orbit Transfer")
transfer_short.a, transfer_short.p, transfer_short.e, transfer_short_v1, transfer_short_v2 = universal_lambert( r1_earth, r2_venus, (tof.sec), transfer_short.mu, desired_path='short')
print(f'Short Transfer semi major axis is {transfer_short.a/1000} km -->  {(transfer_short.a/1000/149597870.7)} AU ')
print(f'Short Transfer Eccentricity is: {transfer_short.e}')
print(f'Departure velocity: {transfer_short_v1/1000} km/s')
print(f'Arrival velocity: {transfer_short_v2/1000} km/s\n')
...
print("Long Orbit Transfer")
transfer_long.a, transfer_long.p, transfer_long.e, transfer_long_v1, transfer_long_v2 = universal_lambert(r1_earth, r2_venus, (tof.sec), transfer_short.mu, desired_path='long')
print(f'Long Transfer semi major axis is {transfer_long.a/1000} km --> {(transfer_long.a/1000/149597870.7)} AU')
print(f'Long Transfer Eccentricity is: {transfer_long.e}')
print(f'Departure velocity: {transfer_long_v1/1000} km/s')
print(f'Arrival velocity: {transfer_long_v2/1000} km/s')
