...
def variable_nbody_propagtion(r0, v0, earth_soi, mars_soi, t0, tf):
    ...
    r_helio,v_helio = convert_state_earth_to_helio(r_eci,v_eci,t)
    central_body = sun 
    ...
    r_mci,v_mci = convert_state_helio_to_mars(r_helio,v_helio,t)  
    central_body = mars
...
# I also have to account for earths gravity within its SOI and mars' gravity within its SOI --> so the list of bodies and central has to change  ---> DONE
